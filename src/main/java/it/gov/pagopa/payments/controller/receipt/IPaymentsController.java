...
public interface IPaymentsController {
  ...
  ResponseEntity<String> getReceiptByIUV(
      ...
      @Parameter(
          ...
          String iuv,
      @Valid
          @Parameter(description = "Segregation codes for which broker is authorized")
  ...
  ResponseEntity<PaymentsResult> getOrganizationReceipts(
      ...
      @Parameter(description = "Page number, starts from 0")
          ...
          int pageNum,
      @Valid
          @Parameter(description = "Number of elements per page. Default = 20")
      ...
      @Parameter(description = "Filter by date, from this date")
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          @RequestParam(required = false)
          LocalDateTime from,
      @Parameter(description = "Filter by date, to this date")
          @DateTimeFormat(iso = DateTimeFormat.ISO.DATE)
          @RequestParam(required = false)
          LocalDateTime to,
      @Valid
          ...
          @RequestParam(required = false)
          String segregationCodes,
      @Parameter(description = "Filter start of debtor or IUV") @RequestParam(required = false)
          String debtorOrIuv);
}
