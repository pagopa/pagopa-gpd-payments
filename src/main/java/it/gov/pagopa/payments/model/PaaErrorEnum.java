...
public enum PaaErrorEnum {
  PAA_ID_DOMINIO_ERRATO(
      "PAA_ID_DOMINIO_ERRATO",
      "ID dominio errato",
      "L'idPA ricevuto non e' tra quelli configurati oppure non è associato alla stazione"
          + " richiesta"),
  ...
  PAA_PAGAMENTO_ANNULLATO(
      "PAA_PAGAMENTO_ANNULLATO", "pagamento annullato", "L'id del pagamento ricevuto e' annullato"),
  PAA_PAGAMENTO_SCONOSCIUTO(
      "PAA_PAGAMENTO_SCONOSCIUTO",
      "pagamento sconosciuto",
      "L'id del pagamento ricevuto non esiste"),
  PAA_PAGAMENTO_DUPLICATO(
      "PAA_PAGAMENTO_DUPLICATO",
      "pagamento duplicato",
      "L'id del pagamento ricevuto  e' duplicato"),
  PAA_RECEIPT_DUPLICATA(
      "PAA_RECEIPT_DUPLICATA", "pagamento duplicato", "L'id del pagamento ricevuto  e' duplicato"),
  PAA_PAGAMENTO_SCADUTO(
      "PAA_PAGAMENTO_SCADUTO", "pagamento scaduto", "L'id del pagamento ricevuto  e' scaduto"),
