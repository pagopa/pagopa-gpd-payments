...
class ErrorHandlerTest {
  ...
  void handleError() {
    ...
    ResponseEntity<Object> re =
        eh.handleHttpMessageNotReadable(
            new HttpMessageNotReadableException("error", inputMessage), null, null, null);
    assertEquals(HttpStatus.BAD_REQUEST, re.getStatusCode());

    re =
        eh.handleMissingServletRequestParameter(
            new MissingServletRequestParameterException("name", "type"), null, null, null);
    assertEquals(HttpStatus.BAD_REQUEST, re.getStatusCode());
